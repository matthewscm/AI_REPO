...
def launch_setup(context, *args, **kwargs):
    ...
    #    Adds collision boxes to the planning scene regardless of mode.
    # -----------------------------------------------------------------------
    ...
    # -----------------------------------------------------------------------
    # 4. UR Driver + sensor pipeline  (REAL ROBOT ONLY)
    # -----------------------------------------------------------------------
    real_robot_nodes = []
    if not is_sim:
    ...
    # -----------------------------------------------------------------------
    # 6. move_to_pose  (both modes)
    #    Timeline:
    #      t=0s   MoveIt + RViz starts
    #      t=5s   bottles appear  (sim: spawner / real: classifier)
    #      t=6s   static environment collision boxes added
    #      t=12s  mission control GUI opens
    #      t=15s  move_to_pose starts
    #      t=18s  internal sleep ends, node queries scene and begins motion
    # -----------------------------------------------------------------------
